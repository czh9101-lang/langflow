...
async def _run_graph_with_events(
    ...
    try:
        ...
        # The span is opened here, not inside async_start: this is a coroutine, so it can be made
        # current and everything the run does nests under it. See Graph.async_start.
